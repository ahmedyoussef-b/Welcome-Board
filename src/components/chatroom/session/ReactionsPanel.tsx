...
import { ThumbsUp, ThumbsDown, Laugh, Heart, HelpCircle, Lightbulb } from 'lucide-react';
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-500">{reactionLabels[reaction.type as keyof typeof reactionLabels]}</span>
                      </div>
